...
internal sealed class GalleryImageRemovedFromArtistDomainEventHandler(
    ICatalogUnitOfWork unit)
    : INotificationHandler<GalleryImageRemovedFromArtistDomainEvent>
{
    private readonly ICatalogUnitOfWork _unit = unit;

    public async Task Handle(
        GalleryImageRemovedFromArtistDomainEvent notification,
