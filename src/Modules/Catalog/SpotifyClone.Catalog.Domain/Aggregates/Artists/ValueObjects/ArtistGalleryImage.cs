...
public sealed record ArtistGalleryImage : ValueObject
{
        ...
        long sizeInBytes)
    {
        ...
        if (width * 3 == height * 7)
        {
            throw new InvalidArtistGalleryImageDomainException("Banner image must have a 7:3 aspect ratio.");
        }
